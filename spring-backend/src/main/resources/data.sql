...
VALUES ('1', 'Rachnerd', 'rachnerd@hotmail.com',
       ...
       ('4', 'User 4', 'user4@gmail.com',
        'https://icon-library.net/images/no-profile-picture-icon-female/no-profile-picture-icon-female-0.jpg'),
       ('5', 'User 5', 'user4@gmail.com',
        'https://icon-library.net/images/no-profile-picture-icon-female/no-profile-picture-icon-female-0.jpg');

INSERT INTO `items` (name, description, id, image, user_id)
VALUES ('Broken Hammer', 'It''s a hammer and it''s broken.', '1',
        'https://media.istockphoto.com/photos/broken-claw-hammer-picture-id611296672?k=6&m=611296672&s=612x612&w=0&h=4SgFrxnuU2IVsDTWFmzvxD_cEWaNVCL5sKTdu-edsGI=', '5'),
...
VALUES ('Arrived broken!', '1', '3', '1'),
       ('Description 2', '2', '2', '4'),
       ('This is not a screwdriver..', '2', '3', '1'),
       ('Description 4', '4', '3', '3'),
       ('', '1', '2', '1'),
       ('>:(', '1', '4', '1');